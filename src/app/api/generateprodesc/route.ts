...
export async function POST(req: NextRequest) {
  try {
    ...
    const systemMessage = `You are an expert resume Generator AI. Your task is to generate a single project description based on the user input what project he made. `;
